...
function addChat(input, diseaseName,description) {
    ...
    botDiv.innerHTML = `<span id="bot-response"><b>Disease might be ${diseaseName}</b></span><br><span id="bot-description">${description} <br></br></br></span>`;
    ...
    voiceControl(["Disease might be"+diseaseName]);
}